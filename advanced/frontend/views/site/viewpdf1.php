...
?>
<div class="col-xs-5 col-md-3" style="border: black solid 1px;min-height: 200px !important;padding-top: 20px;margin-top: 15px;">

    <div class="col-xs-4 col-md-3">
         <img src="<?php echo Yii::$app->homeUrl."/images/".$ha->logo_1?>" class="" style="width:70px;">
        <h4><?php echo $ha->nama ?></h4>
    </div>

    <div class="col-xs-8 col-md-8" align="center">
       
        <img src="<?php echo Yii::$app->homeUrl."/images/".$model->foto?>" style="width:70px;">
